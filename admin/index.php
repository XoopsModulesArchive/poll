...
// $Id: index.php,v 1.1 2004/01/29 14:45:23 buennagel Exp $
//  ------------------------------------------------------------------------ //
...
require XOOPS_ROOT_PATH . '/modules/poll/include/constants.php';
require_once XOOPS_ROOT_PATH . '/class/xoopsformloader.php';
require_once XOOPS_ROOT_PATH . '/class/xoopslists.php';
require_once XOOPS_ROOT_PATH . '/class/xoopsblock.php';
require_once XOOPS_ROOT_PATH . '/modules/poll/class/poll.php';
require_once XOOPS_ROOT_PATH . '/modules/poll/class/polloption.php';
require_once XOOPS_ROOT_PATH . '/modules/poll/class/polllog.php';
require_once XOOPS_ROOT_PATH . '/modules/poll/class/pollrenderer.php';
...
if ('list' == $op) {
    ...
    $polls_arr = &poll::getAll([], true, 'weight ASC, end_time DESC', $limit + 1, $start);

    xoops_cp_header();

    echo '<h4>' . _AM_POLLCONF . '</h4>';

    echo "<h4 style='text-align:right;'>" . _AM_POLLSLIST . '</h4>';

    $polls_count = count($polls_arr);

    if (is_array($polls_arr) && $polls_count > 0) {
        echo "<form action='index.php' method='post'><table dir=rtl border='0' cellpadding='0' cellspacing='0' width='100%'><tr><td class='bg2'>
		<table dir=rtl width='100%' border='0' cellpadding='4' cellspacing='1'>
        ...
        for ($i = 0; $i < $max; $i++) {
            ...
            echo "<tr class='bg1'><td align='center'><input type='hidden' name='poll_id[$i]' value='"
                 ...
                 . "</td><td align='center'>"
                 . $polls_arr[$i]->getVar('votes')
                 . '</td><td>'
                 . $end
                 . "</td><td align='left'><a href='index.php?op=edit&amp;poll_id="
                 . $polls_arr[$i]->getVar('poll_id')
                 . "'>"
                 . _EDIT
        ...
        echo "<tr align='left' class='bg3'><td colspan='7'><input type='button' name='button' onclick=\"location='index.php?op=add'\" value='"
             . _AM_ADDPOLL
             . "'> <input type='submit' value='"
             . _SUBMIT
             . "'><input type='hidden' name='op' value='quickupdate'></td></tr></table></td></tr></table></form>";

        echo "<table dir=rtl width='100%'><tr><td align='right'>";
